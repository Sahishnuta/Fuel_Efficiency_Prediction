...
def result():
    ...
    scaler_path=os.path.join(os.path.dirname('E:/DS_Advanced_NLP_Deep_Learning/DL_Projects/Fuel_Efficiency_Prediction/models/'),'scaler.pkl')
    ...
    model=load_model(r"E://DS_Advanced_NLP_Deep_Learning//DL_Projects//Fuel_Efficiency_Prediction//models//scaler.pkl//model.h5")
